 ...
 *
 * <copyright file="DoubleArrayTrieByAhoCorasick.java" company="上海林原信息科技有限公司">
 ...
 * @author hankcs
 */
public class DoubleArrayTrieByAhoCorasick<V> {
    /**
     * 双数组值check
     */
    protected int[] check;
    ...
    public DoubleArrayTrieByAhoCorasick() {
    }
     ...
     * @param dictionary 词典
     */
    public DoubleArrayTrieByAhoCorasick(TreeMap<String, V> dictionary) {
        build(dictionary);
    }
...
//    }
    ...
    private class Builder {
        ...
        private void constructOutput(State targetState) {
            ...
            DoubleArrayTrieByAhoCorasick.this.output[targetState.getIndex()] = output;
        }
